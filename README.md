...
>
> รุ่น 0.6.3 แก้ข้อความแจ้งเตือนเมื่อดาวน์โหลด TikTok ไม่ได้เพราะเว็บไซต์เปลี่ยนระบบ (`Unexpected response from webpage request`) ให้แนะนำกดอัปเดต yt-dlp ได้ถูกจุด
