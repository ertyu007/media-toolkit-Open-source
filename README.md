...
>
> รุ่น 1.0.1 เพิ่มการแยกสเต็มเสียง (เสียงร้อง/ดนตรี) บนเครื่อง และปุ่มอัปเดต yt-dlp ในแอป
...
- **แยกสเต็มเสียง** (เสียงร้อง + ดนตรี และสเต็มอื่นๆ) บนเครื่องด้วย Demucs โดยไม่ต้องเชื่อมอินเทอร์เน็ต
